...
pub struct BalancerNetworksInner {
    ...
    pub ips:      Option<Vec<models::BalancerNetworksInnerIpsInner>>
}

impl BalancerNetworksInner {
    pub fn new(
        r#type: Type,
        ips: Option<Vec<models::BalancerNetworksInnerIpsInner>>
