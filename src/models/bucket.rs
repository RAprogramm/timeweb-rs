...
pub struct Bucket {
    ...
    #[serde(rename = "disk_stats")]
    pub disk_stats:             Box<models::BucketDiskStats>,
    /// Тип хранилища.
    #[serde(rename = "type")]
    pub r#type:                 Type,
    /// ID тарифа хранилища.
    ...
    #[serde(
        rename = "moved_in_quarantine_at",
        deserialize_with = "Option::deserialize"
    )]
    pub moved_in_quarantine_at: Option<chrono::DateTime<chrono::FixedOffset>>,
    /// Класс хранилища.
    ...
    #[serde(rename = "is_allow_auto_upgrade")]
...
impl Bucket {
    ...
    pub fn new(
        ...
        Bucket {
            ...
            access_key,
            secret_key,
            moved_in_quarantine_at,
            storage_class,
            project_id,
            rate_id,
            website_config: if let Some(x) = website_config {
                Some(Box::new(x))
            } else {
                None
            },
            is_allow_auto_upgrade
        }
    }
}
/// Тип хранилища.
