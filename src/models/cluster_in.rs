...
pub struct ClusterIn {
    ...
    /// Логическое значение, которое показывает, использовать ли Ingress в
    /// кластере
    #[serde(rename = "is_ingress", skip_serializing_if = "Option::is_none")]
    pub is_ingress:           Option<bool>,
    /// Логическое значение, которое показывает, использовать ли Kubernetes
    /// Dashboard в кластере
    #[serde(rename = "is_k8s_dashboard", skip_serializing_if = "Option::is_none")]
    ...
    pub configuration:        Option<Box<models::ClusterInConfiguration>>,
    /// Количество мастер нод
    #[serde(rename = "master_nodes_count", skip_serializing_if = "Option::is_none")]
    pub master_nodes_count:   Option<i32>,
    /// Группы воркеров в кластере
    #[serde(rename = "worker_groups", skip_serializing_if = "Option::is_none")]
    pub worker_groups:        Option<Vec<models::NodeGroupIn>>,
    /// ID приватной сети
    ...
    pub maintenance_slot:     Option<Box<models::ClusterInMaintenanceSlot>>,
    #[serde(rename = "oidc_provider", skip_serializing_if = "Option::is_none")]
    pub oidc_provider:        Option<Box<models::ClusterInOidcProvider>>,
    #[serde(
        rename = "cluster_network_cidr",
        skip_serializing_if = "Option::is_none"
    )]
    pub cluster_network_cidr: Option<Box<models::ClusterInClusterNetworkCidr>>
}
