...
/// ConfigDelivery : Настройки раздачи контента
...
pub struct ConfigDelivery {
    ...
    pub large_files:        Option<bool>,
    /// Размер слайса в мегабайтах — файл забирается с источника и кэшируется
    /// частями такого размера. `null` — не использовать слайсинг.
    #[serde(
        rename = "slice_size",
        default,
    ...
    pub slice_size:         Option<Option<i32>>,
    ...
    pub packaging:          Option<Option<Box<models::ConfigDeliveryPackaging>>>
}

impl ConfigDelivery {
    /// Настройки раздачи контента
    pub fn new() -> ConfigDelivery {
        ConfigDelivery {
            http3:              None,
            gzip:               None,
            large_files:        None,
