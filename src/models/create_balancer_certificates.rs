...
pub struct CreateBalancerCertificates {
    /// Тип сертификата.
    ...
    #[serde(rename = "cert_data", skip_serializing_if = "Option::is_none")]
...
impl CreateBalancerCertificates {
    /// Сертификат SSL.
    pub fn new() -> CreateBalancerCertificates {
