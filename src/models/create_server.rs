...
pub struct CreateServer {
    ...
    pub configuration:     Option<Box<models::CreateServerConfiguration>>,
    /// Защита от DDoS. Серверу выдается защищенный IP-адрес с защитой уровня L3
    /// / L4. Для включения защиты уровня L7 необходимо создать тикет в
    ...
    /// Список SSH-ключей.
    #[serde(rename = "ssh_keys_ids", skip_serializing_if = "Option::is_none")]
    pub ssh_keys_ids:      Option<Vec<f64>>,
    /// Локальная сеть.
    #[serde(rename = "is_local_network", skip_serializing_if = "Option::is_none")]
    pub is_local_network:  Option<bool>,
    #[serde(rename = "network", skip_serializing_if = "Option::is_none")]
    pub network:           Option<Box<models::CreateServerNetwork>>,
    /// Cloud-init скрипт
...
impl CreateServer {
    pub fn new(name: String) -> CreateServer {
        CreateServer {
            configuration: None,
            is_ddos_guard: None,
            os_id: None,
