...
/// DbPrivilegeGroup : Привилегия, доступная для кластера базы данных, и её
/// группа доступа
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DbPrivilegeGroup {
    /// Привилегия пользователя базы данных. Возвращаются только те значения,
    /// которые допустимы для типа СУБД запрошенного кластера.
    #[serde(rename = "privilege")]
    pub privilege: Privilege,
    /// Группа доступа, к которой относится привилегия: `GLOBAL` — привилегии
    /// уровня всего кластера, `DATA` — доступ к данным, `STRUCTURE` — изменение
    /// структуры, `OTHERS` — прочие привилегии.
    #[serde(rename = "group")]
    pub group:     Group
}

impl DbPrivilegeGroup {
    /// Привилегия, доступная для кластера базы данных, и её группа доступа
    pub fn new(privilege: Privilege, group: Group) -> DbPrivilegeGroup {
        DbPrivilegeGroup {
            privilege,
            group
        }
...
/// Группа доступа, к которой относится привилегия: `GLOBAL` — привилегии уровня
/// всего кластера, `DATA` — доступ к данным, `STRUCTURE` — изменение структуры,
/// `OTHERS` — прочие привилегии.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Group {
    #[serde(rename = "GLOBAL")]
    Global,
