...
pub struct DedicatedServerPreset {
    ...
    /// Это логическое значение, которое показывает, доступен ли IPMI у данного
    /// тарифа.
    #[serde(rename = "is_ipmi_enabled")]
    pub is_ipmi_enabled:  bool,
    ...
    #[serde(rename = "cpu")]
    pub cpu:              Box<models::DedicatedServerPresetCpu>,
    #[serde(rename = "disk")]
    pub disk:             Box<models::DedicatedServerPresetDisk>,
...
impl DedicatedServerPreset {
    ...
    pub fn new(
        ...
        cpu: models::DedicatedServerPresetCpu,
