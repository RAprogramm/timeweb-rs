...
pub struct DomainProlong {
    ...
    /// \"Антиспам\" для домена
    #[serde(
        rename = "is_antispam_enabled",
        skip_serializing_if = "Option::is_none"
    )]
    pub is_antispam_enabled:      Option<bool>,
...
impl DomainProlong {
    ...
    pub fn new(action: Action, fqdn: String) -> DomainProlong {
        DomainProlong {
            action,
            fqdn,
            is_antispam_enabled: None,
            is_autoprolong_enabled: None,
            is_whois_privacy_enabled: None,
            period: None,
            person_id: None,
            prime: None
        }
