...
pub struct DomainRequest {
    ...
    #[serde(rename = "auth_code", deserialize_with = "Option::deserialize")]
    pub auth_code: Option<String>,
    /// Дата создания заявки.
    #[serde(rename = "date")]
    pub date: chrono::DateTime<chrono::FixedOffset>,
    /// Идентификационный номер бандла, в который входит данная заявка (null -
    /// если заявка не входит ни в один бандл).
    #[serde(rename = "domain_bundle_id", deserialize_with = "Option::deserialize")]
    pub domain_bundle_id: Option<String>,
    /// Код ошибки трансфера домена.
    #[serde(
        rename = "error_code_transfer",
        deserialize_with = "Option::deserialize"
    )]
    pub error_code_transfer: Option<String>,
    /// Полное имя домена.
    #[serde(rename = "fqdn")]
    pub fqdn: String,
    ...
    pub is_antispam_enabled: bool,
    /// Это логическое значение, которое показывает, включено ли автопродление
    /// домена.
    #[serde(rename = "is_autoprolong_enabled")]
    pub is_autoprolong_enabled: bool,
    /// Это логическое значение, которое показывает, включено ли скрытие данных
    /// администратора домена для whois. Опция недоступна для доменов в зонах
    /// .ru и .рф.
    ...
    #[serde(rename = "money_source", deserialize_with = "Option::deserialize")]
    pub money_source: Option<MoneySource>,
    #[serde(rename = "period")]
    ...
    pub soon_expire: f64,
    /// Это значение используется для сортировки доменных зон в панели
    /// управления.
