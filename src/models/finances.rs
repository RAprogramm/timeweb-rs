...
impl Finances {
    ...
    pub fn new(
        balance: f64,
        currency: String,
        discount_end_date_at: Option<String>,
        ...
        autopay_card_info: Option<String>
    ) -> Finances {
        Finances {
            balance,
            currency,
