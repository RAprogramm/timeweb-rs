...
impl std::fmt::Display for Frameworks {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::Beego => write!(f, "beego"),
            Self::Fastapi => write!(f, "fastapi"),
            Self::AspNetCore => write!(f, "ASP.NET Core"),
