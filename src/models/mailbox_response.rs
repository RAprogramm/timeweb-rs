...
pub struct MailboxResponse {
    /// IDN имя домена
    #[serde(rename = "idn_name", skip_serializing_if = "Option::is_none")]
    pub idn_name:          Option<String>,
    /// Сообщение автоответчика
    #[serde(rename = "autoreply_message", skip_serializing_if = "Option::is_none")]
    pub autoreply_message: Option<String>,
    /// Статус автоответчика
    #[serde(rename = "autoreply_status", skip_serializing_if = "Option::is_none")]
    pub autoreply_status:  Option<bool>,
    /// Тема автоответчика
    #[serde(rename = "autoreply_subject", skip_serializing_if = "Option::is_none")]
    pub autoreply_subject: Option<String>,
    /// Комментарий
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment:           Option<String>,
    /// Действие фильтра спама
    #[serde(rename = "filter_action", skip_serializing_if = "Option::is_none")]
    pub filter_action:     Option<FilterAction>,
    /// Статус фильтра спама
    #[serde(rename = "filter_status", skip_serializing_if = "Option::is_none")]
    pub filter_status:     Option<bool>,
    /// Список адресов для пересылки
    #[serde(rename = "forward_list", skip_serializing_if = "Option::is_none")]
    pub forward_list:      Option<Vec<String>>,
    /// Статус пересылки
    #[serde(rename = "forward_status", skip_serializing_if = "Option::is_none")]
    pub forward_status:    Option<bool>,
    /// Контроль исходящей почты
    #[serde(rename = "outgoing_control", skip_serializing_if = "Option::is_none")]
    pub outgoing_control:  Option<bool>,
    /// Email для исходящих писем
    #[serde(rename = "outgoing_email", skip_serializing_if = "Option::is_none")]
    pub outgoing_email:    Option<String>,
    /// Пароль (пустая строка в ответе)
    #[serde(rename = "password", skip_serializing_if = "Option::is_none")]
    pub password:          Option<String>,
    /// Белый список адресов
    #[serde(rename = "white_list", skip_serializing_if = "Option::is_none")]
    pub white_list:        Option<Vec<String>>,
    /// Доступ к веб-почте
    #[serde(rename = "webmail", skip_serializing_if = "Option::is_none")]
    pub webmail:           Option<bool>,
    /// Использование Dovecot
    #[serde(rename = "dovecot", skip_serializing_if = "Option::is_none")]
    pub dovecot:           Option<bool>,
    /// Полное доменное имя
    #[serde(rename = "fqdn", skip_serializing_if = "Option::is_none")]
    pub fqdn:              Option<String>,
    /// Оставлять копии писем при пересылке
    #[serde(rename = "leave_messages", skip_serializing_if = "Option::is_none")]
    pub leave_messages:    Option<bool>,
    /// Имя почтового ящика
    #[serde(rename = "mailbox", skip_serializing_if = "Option::is_none")]
    pub mailbox:           Option<String>,
    /// ФИО владельца
    #[serde(rename = "owner_full_name", skip_serializing_if = "Option::is_none")]
