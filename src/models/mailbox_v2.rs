...
pub struct MailboxV2 {
    /// IDN домен почтового ящика
    #[serde(rename = "idn_name")]
    pub idn_name:          String,
    /// Сообщение автоответчика на входящие письма
    #[serde(rename = "autoreply_message")]
    pub autoreply_message: String,
    /// Включен ли автоответчик на входящие письма
    #[serde(rename = "autoreply_status")]
    pub autoreply_status:  bool,
    /// Тема сообщения автоответчика на входящие письма
    #[serde(rename = "autoreply_subject")]
    pub autoreply_subject: String,
