...
pub struct NodeGroupIn {
    ...
    #[serde(rename = "name")]
    pub name:           String,
    /// ID тарифа воркер-ноды. Нельзя передавать вместе с `configuration`.
    ...
    pub configuration:  Option<Box<models::NodeGroupInConfiguration>>,
    /// Количество нод в группе
    #[serde(rename = "node_count")]
    pub node_count:     i32,
    /// Лейблы для группы нод
    #[serde(rename = "labels", skip_serializing_if = "Option::is_none")]
    pub labels:         Option<Vec<models::SetLabels>>,
    /// Автомасштабирование. Автоматическое увеличение и уменьшение количества
    /// нод в группе в зависимости от текущей нагрузки
    #[serde(rename = "is_autoscaling", skip_serializing_if = "Option::is_none")]
    pub is_autoscaling: Option<bool>,
    /// Минимальное количество нод. Передавать в связке с параметрами
    /// `is_autoscaling` и `max_size`
    #[serde(rename = "min-size", skip_serializing_if = "Option::is_none")]
    pub min_size:       Option<i32>,
    /// Максимальное количество нод. Передавать в связке с параметрами
    ...
    #[serde(rename = "is_autohealing", skip_serializing_if = "Option::is_none")]
