...
pub struct TopLevelDomain {
    /// Список доступных периодов для регистрации/продления доменов со
    /// стоимостью.
    #[serde(rename = "allowed_buy_periods")]
    pub allowed_buy_periods: Vec<models::TopLevelDomainAllowedBuyPeriodsInner>,
    /// Количество дней до истечение срока регистрации, когда можно продлять
    /// домен.
    #[serde(
        rename = "early_renew_period",
        deserialize_with = "Option::deserialize"
    )]
    pub early_renew_period: Option<f64>,
    /// Количество дней, которые действует льготный период когда вы ещё можете
    /// продлить домен, после окончания его регистрации
    ...
    /// Это логическое значение, которое показывает, зарегистрирована ли
    /// доменная зона.
    #[serde(rename = "is_registered")]
    pub is_registered: bool,
    /// Это логическое значение, которое показывает, включено ли по умолчанию
    /// скрытие данных администратора для доменной зоны.
    #[serde(rename = "is_whois_privacy_default_enabled")]
    pub is_whois_privacy_default_enabled: bool,
    /// Это логическое значение, которое показывает, доступно ли управление
    /// скрытием данных администратора для доменной зоны.
    #[serde(rename = "is_whois_privacy_enabled")]
    ...
    #[serde(rename = "whois_privacy_price")]
...
pub enum Registrar {
    ...
    Timeweb,
    #[serde(rename = "TimewebVirtreg")]
    TimewebVirtreg,
    #[serde(rename = "Webnames")]
    Webnames,
