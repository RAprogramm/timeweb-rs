...
pub struct TransferStorageRequest {
    ...
    pub location:            String,
    /// Это логическое значение, которое показывает, следует ли принудительно
    /// указывать URL-адреса для объектов S3.
    #[serde(rename = "is_force_path_style")]
    ...
    #[serde(rename = "new_bucket_name")]
    pub new_bucket_name:     String
}

impl TransferStorageRequest {
    pub fn new(
        access_key: String,
        secret_key: String,
        location: String,
