...
pub struct UpdateBalancer {
    /// Удобочитаемое имя, установленное для балансировщика. Должно быть
    /// уникальным в рамках аккаунта
    ...
    /// в качестве прокси.
    #[serde(rename = "is_use_proxy", skip_serializing_if = "Option::is_none")]
    pub is_use_proxy:        Option<bool>,
    /// Это логическое значение, которое показывает, требуется ли
    /// перенаправление на SSL.
    #[serde(rename = "is_ssl", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "is_keepalive", skip_serializing_if = "Option::is_none")]
    pub is_keepalive:        Option<bool>,
    /// Протокол.
    ...
    /// Интервал проверки.
    #[serde(rename = "inter", skip_serializing_if = "Option::is_none")]
    pub inter:               Option<f64>,
    /// Таймаут ответа балансировщика.
    #[serde(rename = "timeout", skip_serializing_if = "Option::is_none")]
    pub timeout:             Option<f64>,
    /// Порог количества ошибок.
    #[serde(rename = "fall", skip_serializing_if = "Option::is_none")]
    pub fall:                Option<f64>,
    /// Порог количества успешных ответов.
    #[serde(rename = "rise", skip_serializing_if = "Option::is_none")]
    pub rise:                Option<f64>,
    ...
    /// Таймаут клиента.
    #[serde(rename = "client_timeout", skip_serializing_if = "Option::is_none")]
    pub client_timeout:      Option<f64>,
    /// Таймаут сервера.
    #[serde(rename = "server_timeout", skip_serializing_if = "Option::is_none")]
    pub server_timeout:      Option<f64>,
    /// Таймаут HTTP запроса.
    #[serde(
        rename = "httprequest_timeout",
    ...
    pub certificates:        Option<Box<models::CreateBalancerCertificates>>
}

impl UpdateBalancer {
    pub fn new() -> UpdateBalancer {
        UpdateBalancer {
            name:                None,
            algo:                None,
            is_sticky:           None,
