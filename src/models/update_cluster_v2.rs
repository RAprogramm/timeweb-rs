...
/// UpdateClusterV2 : Изменение кластера базы данных (v2)
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateClusterV2 {
    ...
    /// Плавающий IP-адрес, который нужно привязать к кластеру базы данных.
    /// Передается сам адрес, а не его ID; адрес должен быть свободен (не
    /// привязан к другому сервису).
    #[serde(rename = "floating_ip", skip_serializing_if = "Option::is_none")]
    pub floating_ip: Option<String>,
    /// Включить защищенное подключение к кластеру базы данных. Обратите
    /// внимание: в ответе это же значение возвращается под ключом
    ...
    pub maintenance_slot: Option<Box<models::UpdateClusterV2MaintenanceSlot>>,
    #[serde(rename = "disk_autoscaling", skip_serializing_if = "Option::is_none")]
    pub disk_autoscaling: Option<Box<models::UpdateClusterV2DiskAutoscaling>>
}

impl UpdateClusterV2 {
    /// Изменение кластера базы данных (v2)
    pub fn new() -> UpdateClusterV2 {
        UpdateClusterV2 {
            name: None,
            preset_id: None,
            configuration: None,
